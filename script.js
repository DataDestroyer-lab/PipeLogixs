...
const benderLibrary = [
    // --- GREENLEE (GREEN) ---
    { id: 'gl_50', cat: 'hand', brand: 'Greenlee', model: '1/2" Hand', size: '1/2" EMT', ded: 5, gain: 2.65, color: '#2E7D32' },
    { id: 'gl_75', cat: 'hand', brand: 'Greenlee', model: '3/4" Hand', size: '3/4" EMT', ded: 6, gain: 3.25, color: '#2E7D32' },
    { id: 'gl_100', cat: 'hand', brand: 'Greenlee', model: '1" Hand', size: '1" EMT', ded: 8, gain: 4.0, color: '#2E7D32' },
    { id: 'gl_r50', cat: 'hand', brand: 'Greenlee', model: '1/2" Rigid', size: '1/2" Rigid', ded: 6, gain: 3.2, color: '#2E7D32' },
    
    // --- ELECTRIC / HYDRAULIC ---
    { id: 'gl_555', cat: 'electric', brand: 'Greenlee', model: '555 Electric', size: 'Multi-Shoe', ded: 0, gain: 0, color: '#2E7D32' },
    { id: 'gl_854', cat: 'electric', brand: 'Greenlee', model: '854DX', size: 'Multi-Shoe', ded: 0, gain: 0, color: '#2E7D32' },
    ...
    { id: 'gl_chic', cat: 'electric', brand: 'Greenlee', model: 'Chicago', size: 'Mechanical', ded: 0, gain: 0, color: '#2E7D32' },
    { id: 'gl_one', cat: 'electric', brand: 'Greenlee', model: 'One Shot 882', size: 'Hydraulic', ded: 0, gain: 0, color: '#2E7D32' },

    // --- IDEAL (BLUE) ---
    { id: 'id_50', cat: 'hand', brand: 'Ideal', model: '1/2" Hand', size: '1/2" EMT', ded: 5, gain: 2.65, color: '#0277BD' },
    { id: 'id_75', cat: 'hand', brand: 'Ideal', model: '3/4" Hand', size: '3/4" EMT', ded: 6, gain: 3.25, color: '#0277BD' },
    { id: 'id_100', cat: 'hand', brand: 'Ideal', model: '1" Hand', size: '1" EMT', ded: 8, gain: 4.0, color: '#0277BD' },
    { id: 'id_r50', cat: 'hand', brand: 'Ideal', model: '1/2" Rigid', size: '1/2" Rigid', ded: 6, gain: 3.2, color: '#0277BD' },
